...
public class FuncionarioController {
    ...
    // http://localhost:8080/editar-funcionario - Método para editar um funcionário por id
    @RequestMapping(value = "/editar-funcionario", method = RequestMethod.POST)
    public String updateFuncionario(@Valid Funcionario funcionario,  BindingResult bindingResult, RedirectAttributes attributes){
